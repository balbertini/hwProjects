...
`timescale 1 ps / 1 ps
module testeHps_mm_interconnect_0 (
		...
		output wire [1:0]  chaves_s1_address,                                                   //                                                     chaves_s1.address
		input  wire [31:0] chaves_s1_readdata,                                                  //                                                              .readdata
	...
	wire   [31:0] chaves_s1_agent_m0_readdata;                              // chaves_s1_translator:uav_readdata -> chaves_s1_agent:m0_readdata
	wire          chaves_s1_agent_m0_waitrequest;                           // chaves_s1_translator:uav_waitrequest -> chaves_s1_agent:m0_waitrequest
	wire          chaves_s1_agent_m0_debugaccess;                           // chaves_s1_agent:m0_debugaccess -> chaves_s1_translator:uav_debugaccess
	wire   [20:0] chaves_s1_agent_m0_address;                               // chaves_s1_agent:m0_address -> chaves_s1_translator:uav_address
	wire    [3:0] chaves_s1_agent_m0_byteenable;                            // chaves_s1_agent:m0_byteenable -> chaves_s1_translator:uav_byteenable
	wire          chaves_s1_agent_m0_read;                                  // chaves_s1_agent:m0_read -> chaves_s1_translator:uav_read
	wire          chaves_s1_agent_m0_readdatavalid;                         // chaves_s1_translator:uav_readdatavalid -> chaves_s1_agent:m0_readdatavalid
	wire          chaves_s1_agent_m0_lock;                                  // chaves_s1_agent:m0_lock -> chaves_s1_translator:uav_lock
	wire   [31:0] chaves_s1_agent_m0_writedata;                             // chaves_s1_agent:m0_writedata -> chaves_s1_translator:uav_writedata
	wire          chaves_s1_agent_m0_write;                                 // chaves_s1_agent:m0_write -> chaves_s1_translator:uav_write
	wire    [2:0] chaves_s1_agent_m0_burstcount;                            // chaves_s1_agent:m0_burstcount -> chaves_s1_translator:uav_burstcount
	wire          chaves_s1_agent_rf_source_valid;                          // chaves_s1_agent:rf_source_valid -> chaves_s1_agent_rsp_fifo:in_valid
	wire  [112:0] chaves_s1_agent_rf_source_data;                           // chaves_s1_agent:rf_source_data -> chaves_s1_agent_rsp_fifo:in_data
	wire          chaves_s1_agent_rf_source_ready;                          // chaves_s1_agent_rsp_fifo:in_ready -> chaves_s1_agent:rf_source_ready
	wire          chaves_s1_agent_rf_source_startofpacket;                  // chaves_s1_agent:rf_source_startofpacket -> chaves_s1_agent_rsp_fifo:in_startofpacket
	wire          chaves_s1_agent_rf_source_endofpacket;                    // chaves_s1_agent:rf_source_endofpacket -> chaves_s1_agent_rsp_fifo:in_endofpacket
	wire          chaves_s1_agent_rsp_fifo_out_valid;                       // chaves_s1_agent_rsp_fifo:out_valid -> chaves_s1_agent:rf_sink_valid
	wire  [112:0] chaves_s1_agent_rsp_fifo_out_data;                        // chaves_s1_agent_rsp_fifo:out_data -> chaves_s1_agent:rf_sink_data
	wire          chaves_s1_agent_rsp_fifo_out_ready;                       // chaves_s1_agent:rf_sink_ready -> chaves_s1_agent_rsp_fifo:out_ready
	wire          chaves_s1_agent_rsp_fifo_out_startofpacket;               // chaves_s1_agent_rsp_fifo:out_startofpacket -> chaves_s1_agent:rf_sink_startofpacket
	wire          chaves_s1_agent_rsp_fifo_out_endofpacket;                 // chaves_s1_agent_rsp_fifo:out_endofpacket -> chaves_s1_agent:rf_sink_endofpacket
	wire          chaves_s1_agent_rdata_fifo_src_valid;                     // chaves_s1_agent:rdata_fifo_src_valid -> chaves_s1_agent_rdata_fifo:in_valid
	wire   [33:0] chaves_s1_agent_rdata_fifo_src_data;                      // chaves_s1_agent:rdata_fifo_src_data -> chaves_s1_agent_rdata_fifo:in_data
	wire          chaves_s1_agent_rdata_fifo_src_ready;                     // chaves_s1_agent_rdata_fifo:in_ready -> chaves_s1_agent:rdata_fifo_src_ready
	...
	wire          leds_s1_agent_rp_valid;                                   // leds_s1_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] leds_s1_agent_rp_data;                                    // leds_s1_agent:rp_data -> router_002:sink_data
	wire          leds_s1_agent_rp_ready;                                   // router_002:sink_ready -> leds_s1_agent:rp_ready
	wire          leds_s1_agent_rp_startofpacket;                           // leds_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          leds_s1_agent_rp_endofpacket;                             // leds_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          chaves_s1_agent_rp_valid;                                 // chaves_s1_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] chaves_s1_agent_rp_data;                                  // chaves_s1_agent:rp_data -> router_003:sink_data
	wire          chaves_s1_agent_rp_ready;                                 // router_003:sink_ready -> chaves_s1_agent:rp_ready
	wire          chaves_s1_agent_rp_startofpacket;                         // chaves_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          chaves_s1_agent_rp_endofpacket;                           // chaves_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> leds_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> leds_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // leds_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> leds_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> leds_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> leds_s1_burst_adapter:sink0_endofpacket
	wire          leds_s1_burst_adapter_source0_valid;                      // leds_s1_burst_adapter:source0_valid -> leds_s1_agent:cp_valid
	wire  [111:0] leds_s1_burst_adapter_source0_data;                       // leds_s1_burst_adapter:source0_data -> leds_s1_agent:cp_data
	wire          leds_s1_burst_adapter_source0_ready;                      // leds_s1_agent:cp_ready -> leds_s1_burst_adapter:source0_ready
	wire    [1:0] leds_s1_burst_adapter_source0_channel;                    // leds_s1_burst_adapter:source0_channel -> leds_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> chaves_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> chaves_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // chaves_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> chaves_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> chaves_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> chaves_s1_burst_adapter:sink0_endofpacket
	wire          chaves_s1_burst_adapter_source0_valid;                    // chaves_s1_burst_adapter:source0_valid -> chaves_s1_agent:cp_valid
	wire  [111:0] chaves_s1_burst_adapter_source0_data;                     // chaves_s1_burst_adapter:source0_data -> chaves_s1_agent:cp_data
	wire          chaves_s1_burst_adapter_source0_ready;                    // chaves_s1_agent:cp_ready -> chaves_s1_burst_adapter:source0_ready
	wire    [1:0] chaves_s1_burst_adapter_source0_channel;                  // chaves_s1_burst_adapter:source0_channel -> chaves_s1_agent:cp_channel
	wire          chaves_s1_burst_adapter_source0_startofpacket;            // chaves_s1_burst_adapter:source0_startofpacket -> chaves_s1_agent:cp_startofpacket
	wire          chaves_s1_burst_adapter_source0_endofpacket;              // chaves_s1_burst_adapter:source0_endofpacket -> chaves_s1_agent:cp_endofpacket
	...
	wire          leds_s1_agent_rdata_fifo_out_valid;                       // leds_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] leds_s1_agent_rdata_fifo_out_data;                        // leds_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          leds_s1_agent_rdata_fifo_out_ready;                       // avalon_st_adapter:in_0_ready -> leds_s1_agent_rdata_fifo:out_ready
	...
	wire          chaves_s1_agent_rdata_fifo_out_valid;                     // chaves_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] chaves_s1_agent_rdata_fifo_out_data;                      // chaves_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          chaves_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_001:in_0_ready -> chaves_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> chaves_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> chaves_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // chaves_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> chaves_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) chaves_s1_translator (
		.clk                    (clk_0_clk_clk),                          //                      clk.clk
		.reset                  (leds_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (chaves_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (chaves_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (chaves_s1_agent_m0_read),                //                         .read
		.uav_write              (chaves_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (chaves_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (chaves_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (chaves_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (chaves_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (chaves_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (chaves_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (chaves_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (chaves_s1_address),                      //      avalon_anti_slave_0.address
		.av_readdata            (chaves_s1_readdata),                     //                         .readdata
		.av_write               (),                                       //              (terminated)
		.av_read                (),                                       //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (leds_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (chaves_s1_agent_m0_address),                    //              m0.address
		.m0_burstcount           (chaves_s1_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (chaves_s1_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (chaves_s1_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (chaves_s1_agent_m0_lock),                       //                .lock
		.m0_readdata             (chaves_s1_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (chaves_s1_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (chaves_s1_agent_m0_read),                       //                .read
		.m0_waitrequest          (chaves_s1_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (chaves_s1_agent_m0_writedata),                  //                .writedata
		.m0_write                (chaves_s1_agent_m0_write),                      //                .write
		.rp_endofpacket          (chaves_s1_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (chaves_s1_agent_rp_ready),                      //                .ready
		.rp_valid                (chaves_s1_agent_rp_valid),                      //                .valid
		.rp_data                 (chaves_s1_agent_rp_data),                       //                .data
		.rp_startofpacket        (chaves_s1_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (chaves_s1_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (chaves_s1_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (chaves_s1_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (chaves_s1_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (chaves_s1_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (chaves_s1_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (chaves_s1_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (chaves_s1_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (chaves_s1_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (chaves_s1_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (chaves_s1_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (chaves_s1_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (chaves_s1_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (chaves_s1_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (chaves_s1_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (chaves_s1_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),             // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),             //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),              //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),             //                .error
		.rdata_fifo_src_ready    (chaves_s1_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (chaves_s1_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (chaves_s1_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                         //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                           //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) chaves_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                              //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (chaves_s1_agent_rf_source_data),             //        in.data
		.in_valid          (chaves_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (chaves_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (chaves_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (chaves_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (chaves_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (chaves_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (chaves_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (chaves_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (chaves_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                      // (terminated)
		.csr_read          (1'b0),                                       // (terminated)
		.csr_write         (1'b0),                                       // (terminated)
		.csr_readdata      (),                                           // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) chaves_s1_agent_rdata_fifo (
		.clk               (clk_0_clk_clk),                          //       clk.clk
		.reset             (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (chaves_s1_agent_rdata_fifo_src_data),    //        in.data
		.in_valid          (chaves_s1_agent_rdata_fifo_src_valid),   //          .valid
		.in_ready          (chaves_s1_agent_rdata_fifo_src_ready),   //          .ready
		.out_data          (chaves_s1_agent_rdata_fifo_out_data),    //       out.data
		.out_valid         (chaves_s1_agent_rdata_fifo_out_valid),   //          .valid
		.out_ready         (chaves_s1_agent_rdata_fifo_out_ready),   //          .ready
		.csr_address       (2'b00),                                  // (terminated)
		.csr_read          (1'b0),                                   // (terminated)
		.csr_write         (1'b0),                                   // (terminated)
		.csr_readdata      (),                                       // (terminated)
	...
	testeHps_mm_interconnect_0_router router (
	...
	testeHps_mm_interconnect_0_router router_001 (
	...
	testeHps_mm_interconnect_0_router_002 router_002 (
	...
	testeHps_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (chaves_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (chaves_s1_agent_rp_valid),               //          .valid
		.sink_data          (chaves_s1_agent_rp_data),                //          .data
		.sink_startofpacket (chaves_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (chaves_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.source0_valid         (chaves_s1_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (chaves_s1_burst_adapter_source0_data),          //          .data
		.source0_channel       (chaves_s1_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (chaves_s1_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (chaves_s1_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (chaves_s1_burst_adapter_source0_ready)          //          .ready
	);

	testeHps_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	testeHps_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	testeHps_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (leds_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	testeHps_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	testeHps_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                          // in_clk_0.clk
		.in_rst_0_reset (leds_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (chaves_s1_agent_rdata_fifo_out_data),    //     in_0.data
		.in_0_valid     (chaves_s1_agent_rdata_fifo_out_valid),   //         .valid
		.in_0_ready     (chaves_s1_agent_rdata_fifo_out_ready),   //         .ready
